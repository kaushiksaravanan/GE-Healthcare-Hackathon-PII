...
import "../logs-contents/view-grievance.css";
...
const AdminViewGrievance = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(defaultVariables["backend-url"] + "grievance/view/get?id=" + id)
      .then((res) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(
        defaultVariables["backend-url"] + "admin/grievance/update",
        grievance
      )
      .then((res) => {
        setTimeout(() => {
          ...
          <p className="details-value">
            ...
            {departmentThree && (
              <div className="details-div">
                ...
                <p className="details-value">
                  {departmentThree.departmentName}
                </p>
              </div>
            )}
          </p>
