...
host = ""         # MySQL: localhost:3306, Postgres: localhost:5432, SQLite: D:/Hackathons/GE Healthcare/GE-Healthcare-Hackathon/testing/database_dumb_dir
database = "test.db"               # MySQL & Postgres: test, Sqlite: test.db
engine_type = "sqlite"        # MySQL: mysql, Postgres: postgres, SQLite: sqlite
